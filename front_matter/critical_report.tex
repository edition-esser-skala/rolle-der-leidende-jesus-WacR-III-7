...
Bass figures appear in the following movements (bars in parentheses): 1.1, 1.3, 1.5 (1), 1.7, 1.8, 1.10 (94), 1.11, 1.12 (2, 18, 26), 1.14 (3, 6, 9), 1.16 (1, 2, 15, 17), 1.18 (11, 16, 17), 1.21, 2.1 (18, 20, 22, 59, 60, 79), 2.3 (5, 24), 2.4 (8, 16, 17, 20, 28), 2.6, 2.9 (3, 4, 6, 8, 11, 21), 2.10 (1–3, 14, 17). The remaining bass figures were added by the editor.
